...
//    }
    ...
    private void setupControls() {
        final EditText txtPhoneNumber = this.findViewById(R.id.txtPhoneNumber);
        final EditText txtMessage = this.findViewById(R.id.txtMessage);
...
//                Intent msgSent = new Intent(Intent.ACTION_SEND);
                ...
                final PendingIntent pendingMsgSent =
                        PendingIntent.getBroadcast(ImplicitIntentActivity.this, 0, msgSent, 0);
                ...
                registerReceiver(new BroadcastReceiver() {
                    public void onReceive(Context context, Intent intent) {
                        ...
                        Toast.makeText(ImplicitIntentActivity.this, msg,
